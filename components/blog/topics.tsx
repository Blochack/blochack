            ...
            <Container>
                ...
                <div className="grid gap-4 md:grid-cols-3 sm:grid-cols-1">
                    <div className="mt-8 group">
                        <div className="relative cursor-pointer bg-[url('/images/blogImg1.png')] rounded-xl h-[266px] group-hover:scale-105 transition duration-1000 ease-in-out">
                    ...
                    <div className="mt-8 group">
                        <div className="relative cursor-pointer bg-[url('/images/blogImg2.png')] rounded-xl h-[266px] group-hover:scale-105 transition duration-1000 ease-in-out">
                            <p className="absolute right-4 top-4 bg-[rgba(39,42,50,0.6)] text-sm py-2 px-4 bg-transparent-100 rounded-full">Partnership</p>
                        </div>
                        <div>
                            <p className="text-xl w-4/5 py-4">Phishing Defense Powered by BlocHack</p>
                    ...
                    <div className="mt-8 group">
                        <div className="relative cursor-pointer bg-[url('/images/blogImg3.png')] rounded-xl h-[266px] group-hover:scale-105 transition duration-1000 ease-in-out">
                            <p className="absolute right-4 top-4 bg-[rgba(39,42,50,0.6)] text-sm py-2 px-4 bg-transparent-100 rounded-full">Partnership</p>
                        </div>
                        <div>
                            <p className="text-xl w-4/5 py-4">Phishing Defense Powered by BlocHack</p>
