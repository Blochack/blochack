                    ...
                    <div className="relative z-10 mx-auto max-w-2xl lg:col-span-6 lg:max-w-none lg:pt-6 xl:col-span-6">
...

                        {
                            [
                                {
                                    id: 1,
                                    first: "Instant notifications",
                                    second: "Our advanced algorithms analyze incoming transactions and suspicious activity 24/7, instantly notifying you of potential hacks targeting your monitored addresses"
                                },
                                {
                                    id: 2,
                                    first: "Granular control",
                                    second: "Choose which addresses you want to prioritize for real-time monitoring, ensuring you receive the most relevant alerts"
                                },
                                {
                                    id: 3,
                                    first: "Actionable insights",
                                    second: "Each notification goes beyond just a red flag. We provide detailed information about the suspected threat, to ensure you to make informed decisions"
                                },
                            ].map((e, i) => {
                                return (
