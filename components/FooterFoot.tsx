    ...
    return (
        // <div className="pb-7">
            <div className="w-full px-6 pb-7">
                <div className="h-3 border-b border-gray-200 opacity-30 w-full mb-7"></div>
                <div className="flex flex-row justify-between w-full">
                    <div className="flex flex-row justify-start w-full gap-4 cursor-pointer">
                        <div className="w-[18px] hover:fill='bg-primary'">
